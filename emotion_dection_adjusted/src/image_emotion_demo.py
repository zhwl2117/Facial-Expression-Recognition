...
from src.inference import load_image
...
# loading images
rgb_image = load_image(image_path, gray_scale=False)
gray_image = load_image(image_path, gray_scale=True)
...
cv2.imwrite('../images/predicted_test_image_' + image_name + '.png', bgr_image)
